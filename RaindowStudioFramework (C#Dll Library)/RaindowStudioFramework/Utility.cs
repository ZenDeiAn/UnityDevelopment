...
namespace RaindowStudio.Utility
{
    public static class Utility
    {
        ...
        public static void UpdateEnumInDynamicCodeScript(string enumName, string[] enums, Action<Dictionary<string, int>> resortedAction = null) => UpdateEnumInScript(Path.Combine(Application.dataPath, @"RaindowStudio\Scripts\Runtime\DynamicCode.cs"), enumName, enums, resortedAction);
